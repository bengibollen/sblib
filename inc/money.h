...
#define MONEY_MAKE_HERE(num, ctype) \
    ({int}) MONEY_MAKE((num), (ctype))->move(this_object(), 1)
 ...
 */
#define MONEY_PARSE(str) ({mixed}) MONEY_FN->parse_coins(str)
 ...
 */
#define MONEY_PARSE_OB(str, ob) ({mixed}) MONEY_FN->parse_coins(str, ob)
