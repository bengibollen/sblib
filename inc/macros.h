 ...
 */
#define MASTER_OB(ob) (explode(object_name(ob) + "#", "#")[0])
#define MASTER        (MASTER_OB(this_object()))
#define IS_CLONE      (object_name(this_object()) != MASTER)
...
#define OB_NUM(ob)    (explode(object_name(ob) + "#0", "#")[1])
 ...
 */
#define VBFC(fun)    ("@@" + (fun) + "@@")
#define VBFC_ME(fun) ("@@" + (fun) + ":" + object_name(this_object()) + "@@")
 ...
 */
#define CAN_SEE_IN_A_ROOM(ob, room)	objectp(room) && \
