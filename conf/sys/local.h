 ...
 */
#define SMALL_MEMORY_LIMIT 10000000
#define RGE_MEMORY_LIMIT 28000000
 ...
 */
#define NPC_SOULS ({ "/std/cmd/std/soul_cmd", "/std/cmd/std/misc_cmd" })
 ...
 */
// #undef ({ "milou.cd.chalmers.se", "129.16.79.12" })
// #undef "@@@host@@@\n"
// #undef ({ "sponsz.cd.chalmers.se", "129.16.79.31", "castafiore.cd.chalmers.se" })
