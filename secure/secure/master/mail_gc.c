 ...
 *		  whether the specified base_name + object_name refer to an
 *		  existing directory.
 * Arguments:     object_name - The directory name.
 *		  base_name - The parent directory name.
 * Returns:       1 - Directory exists, 0 - Directory does not exist.
 */
static status
directoryp(string object_name, string base_name)
{
    return file_size(base_name + object_name) == -2;
}
 ...
 *		  whether the specified base_name + object_name refer to an
 *		  existing file.
 * Arguments:     object_name - The file name.
 *		  base_name - The parent directory name.
