...
start_poison(object poisoner)
{
    ...
    if (!recovery)
    {
        ...
        responsible_object = object_name(previous_ob);
        responsible_living = "";
        ...
        if (objectp(poisoner))
        {
            if (interactive(poisoner))
            {
                responsible_living += poisoner->query_name() + "; " +
                    object_name(poisoner);
            }
            else
            {
                responsible_living += object_name(poisoner);
            }
        }
        else
        {
